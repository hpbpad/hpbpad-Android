 ...
 * asynchronous call to a server method. When the server responds, the
 * corresponding method on the listener is called.
 * 
 * @author Tim Roes
 */
public interface XMLRPCCallback {
     ...
     * 
     * @param id
     *            The id as returned by the XMLRPCClient.asyncCall(..) method
     *            for this request.
     * @param result
