...
public class CategoryNode {
    ...
    private int level;
    SortedMap<String, CategoryNode> children = new TreeMap<String, CategoryNode>(
    ...
    private static void preOrderTreeTraversal(CategoryNode node, int level,
    ...
    public static ArrayList<CategoryNode> getSortedListOfCategoriesFromRoot(
            CategoryNode node) {
