...
public class Blog {
    ...
    public Blog(int blog_id) throws Exception {
        ...
        if (blogVals != null) {
            ...
            if (blogVals.get(25) != null
                    && blogVals.get(25).toString().length() > 0)
    ...
    public void save(String originalUsername) {
        //save blog to db
        WordPress.wpDB.saveSettings(String.valueOf(this.id), this.url,
                this.homeURL, this.username, this.password, this.httpuser,
                this.httppassword, this.imagePlacement,
                this.featuredImageCapable, this.fullSizeImage,
                this.maxImageWidth, this.maxImageWidthId, this.location,
                this.dotcomFlag, originalUsername, this.postFormats,
                this.dotcom_username, this.dotcom_password, this.api_blogid,
                this.api_key, this.scaledImage, this.scaledImageWidth,
                this.blogOptions);
    }
