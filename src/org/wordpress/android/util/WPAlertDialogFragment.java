        ...
        if (isXMLRPC) {
            ...
            if (error.contains("code 403") || error.contains("code 503")) {
                ...
                if (error.contains("code 503"))
                    b.setMessage(getResources().getText(R.string.login_limit)
                            + " "
                            + getResources().getText(R.string.load_settings));
                else
                    b.setMessage(getResources().getText(
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,
                                ...
                                Intent settingsIntent = new Intent(
                                        getActivity(),
                                        BlogPreferencesActivity.class);
                                settingsIntent.putExtra("id",
