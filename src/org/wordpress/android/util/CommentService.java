...
public class CommentService extends Service {
    ...
    private void _getUpdatedComments() {
        ...
        List<Integer> notificationAccounts = WordPress.wpDB
        ...
        if (notificationAccounts != null) {
            ...
            if (notificationAccounts.size() == 0) {
                ...
                for (int i = 0; i < notificationAccounts.size(); i++) {
                    ...
                    XMLRPCMethodCallback callBack = new XMLRPCMethodCallback() {
                        ...
                        public void callFinished(Object[] result) {
                            ...
                            SharedPreferences prefs = PreferenceManager
                                    .getDefaultSharedPreferences(CommentService.this);
                            boolean sound, vibrate, light;

                            sound = prefs.getBoolean(
                                    "wp_pref_notification_sound", false);
                            vibrate = prefs.getBoolean(
                                    "wp_pref_notification_vibrate", false);
                            light = prefs.getBoolean(
                                    "wp_pref_notification_light", false);
                            ...
                            String commentID = contentHash.get("comment_id")
                                    .toString();
                            if (latestCommentID == 0) {
                                WordPress.wpDB.updateLatestCommentID(accountID,
                                ...
                                notificationIntent.putExtra("fromNotification",
                                        true);
                                PendingIntent pendingIntent = PendingIntent
                                        .getActivity(CommentService.this, 0,
                                                notificationIntent,
                                                Intent.FLAG_ACTIVITY_CLEAR_TOP);

                                String comment = contentHash.get("content")
                                        .toString();
                                String author = contentHash.get("author")
                                        .toString();

                                Notification n = new Notification(
                                        R.drawable.notification_icon, author
                                                + ": " + comment,
                                ...
                                n.setLatestEventInfo(CommentService.this,
                                        accountName, author + ": " + comment,
                                        pendingIntent);
                    ...
                    final Object[] result;
                    try {
                        result = (Object[]) client.call("wp.getComments",
                                params);
