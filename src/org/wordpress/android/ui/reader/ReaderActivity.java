...
public class ReaderActivity extends WPActionBarActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            topicPage = getSupportFragmentManager().getFragment(
                    savedInstanceState,
                    ReaderTopicsSelectorFragment.class.getName());
            detailPage = getSupportFragmentManager().getFragment(
                    savedInstanceState,
                    ReaderDetailPageFragment.class.getName());
        ...
        topicSelector = (RelativeLayout) inflator.inflate(
                R.layout.reader_topics, null);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        getSupportFragmentManager().putFragment(outState,
                ReaderImplFragment.class.getName(), readerPage);
        getSupportFragmentManager().putFragment(outState,
                ReaderTopicsSelectorFragment.class.getName(), topicPage);
        getSupportFragmentManager().putFragment(outState,
                ReaderDetailPageFragment.class.getName(), detailPage);
        getSupportFragmentManager().putFragment(outState,
                ReaderWebPageFragment.class.getName(), webPage);
