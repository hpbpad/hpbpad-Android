...
public class BlogPreferencesActivity extends SherlockFragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(
                EscapeUtils.unescapeHtml(blog.getBlogName()));
        loadSettingsForBlog();
    }
    ...
    protected void onPause() {
        ...
        if (blog.isScaledImage()) {
            ...
            int width = 0;
            try {
                width = Integer.parseInt(scaledImgWidth.getText().toString()
                        .trim());
            ...
            if (error) {
                AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(
                        BlogPreferencesActivity.this);
                dialogBuilder.setTitle(getResources().getText(R.string.error));
                dialogBuilder.setMessage(getResources().getText(
                        R.string.scaled_image_error));
    ...
    private void loadSettingsForBlog() {
        ...
        ((TextView) findViewById(R.id.l_section1)).setText(getResources()
                .getString(R.string.account_details).toUpperCase(
                        Locale.getDefault()));
        ((TextView) findViewById(R.id.l_section2)).setText(getResources()
                .getString(R.string.media).toUpperCase(Locale.getDefault()));
        ((TextView) findViewById(R.id.l_section3)).setText(getResources()
                .getString(R.string.location).toUpperCase(Locale.getDefault()));
        ((TextView) findViewById(R.id.l_maxImageWidth)).setText(getResources()
                .getString(R.string.max_thumbnail_px_width).toUpperCase(
                        Locale.getDefault()));
        ((TextView) findViewById(R.id.l_httpuser)).setText(getResources()
                .getString(R.string.http_credentials).toUpperCase(
                        Locale.getDefault()));
        ...
        ArrayAdapter<Object> spinnerArrayAdapter = new ArrayAdapter<Object>(
                this, R.layout.spinner_textview, new String[] {
                        "Original Size", "100", "200", "300", "400", "500",
        ...
        ((CheckBox) findViewById(R.id.scaledImage))
        ...
        ((CheckBox) findViewById(R.id.fullSizeImage))
                .setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        CheckBox fullSize = (CheckBox) findViewById(R.id.fullSizeImage);
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        boolean deleteSuccess = WordPress.wpDB.deleteAccount(
                                BlogPreferencesActivity.this, blog.getId());
                        if (deleteSuccess) {
                            Toast.makeText(
                                    activity,
                            ...
                            WordPress.wpDB
                                    .deleteLastBlogId(BlogPreferencesActivity.this);
