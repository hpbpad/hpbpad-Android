...
public class AddQuickPressShortcutActivity extends ListActivity {
        ...
        if (accounts.size() > 0) {
            ...
            for (int i = 0; i < accounts.size(); i++) {
                ...
                url = "http://gravatar.com/blavatar/"
                        + StringUtils.getMd5Hash(url.trim()) + "?s=60&d=404";
            ...
            Intent i = new Intent(AddQuickPressShortcutActivity.this,
    ...
    private void buildDialog(int positionParam) {
        ...
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(
                AddQuickPressShortcutActivity.this);
        dialogBuilder.setTitle(R.string.quickpress_add_alert_title);

        final EditText quickPressShortcutName = new EditText(
                AddQuickPressShortcutActivity.this);
        quickPressShortcutName.setText("QP "
                + StringUtils.unescapeHTML(accountNames.get(position)));
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (TextUtils.isEmpty(quickPressShortcutName.getText())) {
                            ...
                            shortcutIntent.putExtra("accountName", StringUtils
                                    .unescapeHTML(accountNames.get(position)));
                            ...
                            addIntent
                                    .putExtra(Intent.EXTRA_SHORTCUT_NAME,
                                            quickPressShortcutName.getText()
                                                    .toString());
                            addIntent.putExtra(
                            ...
                            if (WordPress.currentBlog == null) {
                                try {
                                    WordPress.currentBlog = new Blog(
                                            accountIDs[position]);
                                    WordPress.wpDB
                                            .updateLastBlogId(accountIDs[position]);
                                } catch (Exception e) {
                                }
                            }
    ...
    protected class HomeListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (view == null) {
                ...
                view = (RelativeLayout) inflater.inflate(R.layout.home_row,
                        parent, false);
            }
            ...
            NetworkImageView blavatar = (NetworkImageView) view
                    .findViewById(R.id.blavatar);
