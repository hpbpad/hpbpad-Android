...
public class NotificationsListFragment extends ListFragment {
    ...
    public interface NoteProvider {
        public void onRequestMoreNotifications(ListView listView,
                ListAdapter adapter);
    }
    ...
    protected void requestMoreNotifications() {
        if (mNoteProvider != null) {
            mNoteProvider.onRequestMoreNotifications(getListView(),
                    getListAdapter());
        }
    }
    ...
    class NotesAdapter extends ArrayAdapter<Note> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            TextView detailText = (TextView) view
            ...
            final NetworkImageView avatarView = (NetworkImageView) view
                    .findViewById(R.id.note_avatar);
            ...
            int imageID = getResources().getIdentifier(
                    "note_icon_" + note.getType(), "drawable",
            ...
            final TextView unreadIndicator = (TextView) view
