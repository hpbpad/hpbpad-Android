...
public class FollowRow extends LinearLayout {
    ...
    public void setAction(JSONObject actionJSON) {
        ...
        try {
            if (actionJSON.has(TYPE_FIELD)
                    && actionJSON.getString(TYPE_FIELD).equals(ACTION_TYPE)) {
            ...
            Log.e(TAG,
                    String.format("Could not set action from %s", actionJSON),
                    e);
    ...
    public void setFollowing(boolean following) {
        if (hasParams()) {
            try {
                ...
                Log.e(TAG,
                        String.format("Could not set following %b", following),
                        e);
            }
        }
        ;
    ...
    class LongClickListener implements View.OnLongClickListener {
        ...
        public boolean onLongClick(View v) {
            Toast.makeText(getContext(),
                    getResources().getString(R.string.tooltip_follow),
