...
/**
 * Activity for displaying WordPress content in a webview which may require
 * authentication. Currently, this activity can only load content for the
 * {@link WordPress.currentBlog}.
 */
public class AuthenticatedWebViewActivity extends WebViewActivity {
    ...
    protected String getLoginUrl() {
        ...
        if (loginURL == null) {
            if (mBlog.getUrl().lastIndexOf("/") != -1) {
                return mBlog.getUrl().substring(0,
                        mBlog.getUrl().lastIndexOf("/"))
                        + "/wp-login.php";
            } else {
    ...
    /**
     * WebViewClient that is capable of handling HTTP authentication requests
     * using the HTTP username and password of the blog configured for this
     * activity.
     */
    ...
    protected class WordPressWebChromeClient extends WebChromeClient {
        ...
        public void onProgressChanged(WebView webView, int progress) {
            AuthenticatedWebViewActivity.this.setTitle(context.getResources()
                    .getText(R.string.loading));
            AuthenticatedWebViewActivity.this
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
        ...
        if (itemID == R.id.menu_refresh) {
            ...
            startActivity(Intent.createChooser(share,
                    getResources().getText(R.string.share_link)));
            return true;
