...
public class ThumbnailBus extends
        AbstractBus<ThumbnailMessage, String, ThumbnailBus.MatchStrategy> {
    ...
    class MatchStrategy implements
            AbstractBus.Strategy<ThumbnailMessage, String> {
        public boolean isMatch(ThumbnailMessage message, String filter) {
            return (filter != null && message != null && filter.equals(message
                    .getKey()));
        }
    }
}